...
* *Licencia*: Para gestionar más de 10 espacios de nombres, necesita una suscripción a Astra Control Center.
...
Astra Control gestionará las aplicaciones con estado solo si el almacenamiento está en una clase de almacenamiento compatible con Astra Control. Astra Control Service es compatible con cualquier clase de almacenamiento que admita Astra Trident o un controlador CSI genérico.
