...
=== Es posible que las snapshots fallen en clústeres de Amazon EKS 1,25 o posteriores

Las snapshots de los clústeres de Amazon EKS en la versión 1,25 o posterior pueden fallar porque se utiliza una controladora de snapshot incorrecta.

Como solución alternativa, haga lo siguiente al actualizar instalaciones existentes de EKS 1,25 o posteriores:
