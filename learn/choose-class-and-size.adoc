...
[role="lead"]
Astra Control Service es compatible con Cloud Volumes Service para Google Cloud, Google Persistent Disk o Cloud Volumes ONTAP de NetApp como opciones de back-end de almacenamiento para volúmenes persistentes.
...
Astra Control Service es compatible con Google Persistent Disk como opción de back-end de almacenamiento. Este servicio proporciona almacenamiento en el nivel de bloques gestionado por Google.
