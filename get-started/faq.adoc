...
Sí, puede añadir clústeres GKE privados al servicio Astra Control. Para crear un clúster GKE privado, https://["Siga las instrucciones de este artículo de la base de conocimientos"^].

Los clústeres privados deben tener el https://["redes autorizadas"^] Establezca esta opción para permitir la dirección IP de Astra Control:
